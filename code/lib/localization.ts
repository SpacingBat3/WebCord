...
import { getAppPath, getLocale, getName, showMessageBox } from "#esm:/lib/electron";

// Import fallback translations that will be statically typed.
import * as __clientJSON from "#json:/l10n/client" assert { type: "json" };
import * as __webJSON from "#json:/l10n/web" assert { type: "json" };
import * as __settingsJSON from "#json:/l10n/settings" assert { type: "json" };
